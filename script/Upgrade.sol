...
contract Upgrade is Script {
    ...
    function run() public {
        ...
        address vaultImpl = 0x49b41ee4aDe0611f0CF89a74E326CA7440D441A0;
        PbVelo vault;
        ...
        // vault = PbVelo(payable(0x3eB3D7d12a6421fb4D261D62431b34382fc2f72D));
        // vault.upgradeTo(address(vaultImpl));

        // vault = PbVelo(payable(0x225169A63864f9E6d1B92bdB43118D701fAF7531));
        // vault.upgradeTo(address(vaultImpl));
    }
}