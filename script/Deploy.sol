...
contract Deploy is Script {
    ...
    function run() public {
        ...
        // address pbCrvArb2pImpl = 0x4870E4214cbfe6c033b79d4888adfB5ac002bc1b;
        ...
        PbCrvPolyTri pbCrvPolyTriImpl = new PbCrvPolyTri();

        PbProxy pbCrvPolyTriProxy_WBTC = new PbProxy(
            address(pbCrvPolyTriImpl),
            abi.encodeWithSelector(
                bytes4(keccak256("initialize(address,address)")),
                WBTCAddr,
                treasuryAddr
        ...
        console.log("pbCrvPolyTriProxy_WBTC:", address(pbCrvPolyTriProxy_WBTC));

        PbProxy pbCrvPolyTriProxy_WETH = new PbProxy(
            address(pbCrvPolyTriImpl),
            abi.encodeWithSelector(
                bytes4(keccak256("initialize(address,address)")),
                WETHAddr,
        ...
        console.log("pbCrvPolyTriProxy_WETH:", address(pbCrvPolyTriProxy_WETH));

        PbProxy pbCrvPolyTriProxy_USDC = new PbProxy(
            address(pbCrvPolyTriImpl),
            abi.encodeWithSelector(
                bytes4(keccak256("initialize(address,address)")),
                USDCAddr,
        ...
        console.log("pbCrvPolyTriProxy_USDC:", address(pbCrvPolyTriProxy_USDC));
    }
}
