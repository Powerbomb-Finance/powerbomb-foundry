...
contract Deploy is Script {
    ...
    address treasuryAddr = 0x96E2951CAbeF46E547Ae9eEDc3245d69deA0Be49; // multisig
    ...
    function run() public {
        ...
        console.log("Optimism SETH/ETH WETH", address(proxy));
        // Optimism SETH/ETH WBTC
        proxy = new PbProxy(
            address(pbCrvOpEthImpl),
            abi.encodeWithSelector(
                PbCrvOpEth.initialize.selector,
        ...
        console.log("Optimism SETH/ETH WBTC", address(proxy));
    }
}
