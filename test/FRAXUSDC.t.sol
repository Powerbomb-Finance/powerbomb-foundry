...
contract FRAXUSDCTest is Test {
    ...
    function test() public {
        ...
        console.log(token0.balanceOf(address(this))); // 47.380675211453802292
    ...
    //     // console.log(token1.balanceOf(address(this))); // 24.892078
    ...
    //     // console.log(token0.balanceOf(address(this))); // 37.025852094328807960
    //     // console.log(token1.balanceOf(address(this))); // 0
