...
contract USDCDAITest is Test {
    ...
    function test() public {
        ...
        console.log(token0.balanceOf(address(this))); // 103.064618
    ...
    //     // console.log(token0.balanceOf(address(this))); // 9.234077
    ...
    //     // console.log(token0.balanceOf(address(this))); // 21.849890
    //     // console.log(token1.balanceOf(address(this))); // 0
