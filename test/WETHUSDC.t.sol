...
contract WETHUSDCTest is Test {
    ...
    function test() public {
        ...
        console.log(token0.balanceOf(address(this))); // 0.803396910290300186
    ...
    //     vaultBTC.deposit{value: 10 ether}(token0, 10 ether, swapPerc, amountOut * 95 / 100);
    //     // console.log(token0.balanceOf(address(this))); // 0
    //     // console.log(token1.balanceOf(address(this))); // 11.350911
    ...
    //     // console.log(token0.balanceOf(address(this))); // 0.002067675637088828
    //     // console.log(token1.balanceOf(address(this))); // 0
    ...
    //     // console.log(vaultBTC.getUserBalance(address(this))); // 0.000205988005152519
    //     // console.log(vaultETH.getUserBalance(address(this))); // 0.000121256397543665
    //     // console.log(vaultUSDC.getUserBalance(address(this))); // 0.000100000000000000
    ...
    //     // console.log(vaultBTC.getUserBalanceInUSD(address(this))); // 17073.479463
    //     // console.log(vaultETH.getUserBalanceInUSD(address(this))); // 10050.432847
    //     // console.log(vaultUSDC.getUserBalanceInUSD(address(this))); // 8288.579449
    ...
    //     vaultUSDC.withdraw(lpToken, 0.0001 ether, 0);
    ...
    //     // console.log(address(this).balance - ethBal); // 5.887037402236637160
    //     // console.log(token1.balanceOf(address(this))); // 16973.098186
    //     assertEq(token0.balanceOf(address(vaultBTC)), 0);
    //     assertEq(token1.balanceOf(address(vaultBTC)), 0);
    //     assertEq(address(vaultBTC).balance, 0);
    //     assertEq(lpToken.balanceOf(address(vaultBTC)), 0);
    //     assertEq(token0.balanceOf(address(vaultETH)), 0);
    //     assertEq(token1.balanceOf(address(vaultETH)), 0);
    //     assertEq(address(vaultETH).balance, 0);
    //     assertEq(lpToken.balanceOf(address(vaultETH)), 0);
    //     assertEq(token0.balanceOf(address(vaultUSDC)), 0);
    //     assertEq(token1.balanceOf(address(vaultUSDC)), 0);
    ...
    //     vaultBTC.deposit(token0, 10 ether, 500, 0);
